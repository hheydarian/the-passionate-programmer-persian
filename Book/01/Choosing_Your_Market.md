...
در اینجا ادامه ترجمه متن، با همان سبک و سیاق کتاب، ارائه شده است:
...
در اینجا ادامه ترجمه متن کتاب، با حفظ لحن آموزشی و حرفه‌ای بخش‌های قبل ارائه شده است:
...
در اینجا ادامه ترجمه متن کتاب، با همان لحن و سبک بخش‌های قبلی تقدیم می‌شود:
...
در ادامه ترجمه بخش‌های قبلی، ترجمه بخش‌های ۶ تا پایان متن ارسالی ارائه شده است.
...
ترجمه بخش ۷ کتاب، به سبک بخش‌های قبلی:
...
ترجمه بخش ۸ کتاب، با حفظ لحن و سیاق بخش‌های پیشین:
...
این هم ترجمه بخش‌های ۹ و ۱۰ کتاب، با همان کیفیت و لحن:
...
این هم ترجمه بخش‌های مربوط به داستان جیمز دانکن دیویدسون، با همان کیفیت:
